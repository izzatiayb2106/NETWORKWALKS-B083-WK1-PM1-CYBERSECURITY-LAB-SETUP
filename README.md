...
I accidentally imported Kali Linux first before setting the NAT network configuration. I deleted the Kali Linux Machine, configure network setting and import the Kali Linux again into the Virtual Box and its working fine. 
